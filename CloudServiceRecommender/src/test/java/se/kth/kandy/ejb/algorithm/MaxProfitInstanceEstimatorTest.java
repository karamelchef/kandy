...
public class MaxProfitInstanceEstimatorTest {
  ...
  private MaxProfitInstanceEstimator minCostInstanceEstimator = null;

  @BeforeClass
  public void setUpClass() {
    minCostInstanceEstimator = EjbFactory.getInstance().getMaxProfitInstanceEstimator();
  }
  ...
  public void testEstimateInstanceCost() throws ServiceRecommanderException {
    BigDecimal cost = minCostInstanceEstimator.estimateInstanceProfit("r3.xlarge", "us-west-2c",
        new BigDecimal(0.15).setScale(4, RoundingMode.HALF_UP), 108000000L);
  }

  @Test
  public void testEstimateInstanceCost1() throws ServiceRecommanderException {
    BigDecimal cost = minCostInstanceEstimator.estimateInstanceProfit("d2.2xlarge", "eu-central-1b",
  ...
  void testFindAllInstancesZonesCost() throws Exception {
    List<Ec2Instance> instances = minCostInstanceEstimator.findAllInstancesZonesEstimatedProfit(229727000L, (float) 0.7,
  ...
  void testFindInstanceZonesCost() throws ServiceRecommanderException {
    List<Ec2Instance> instances = minCostInstanceEstimator.findInstanceZonesEstimatedProfit(229727000L, (float) 0.7, "c4.8xlarge");
  }
