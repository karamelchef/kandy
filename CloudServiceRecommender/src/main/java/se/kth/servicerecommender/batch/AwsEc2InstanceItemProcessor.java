...
import se.kth.servicerecommender.json.amazon.AwsEc2Instances;
import se.kth.servicerecommender.json.amazon.OnDemandInstance;
import se.kth.servicerecommender.json.amazon.OnDemandInstanceType;
import se.kth.servicerecommender.json.amazon.Region;
import se.kth.servicerecommender.json.amazon.ReservedInstanceType;
import se.kth.servicerecommender.json.amazon.ReservedPurchaseOption;
import se.kth.servicerecommender.json.amazon.ReservedTerm;
import se.kth.servicerecommender.model.AwsEc2Instance;
import se.kth.servicerecommender.model.AwsEc2InstancePrice;
import se.kth.servicerecommender.model.AwsEc2InstancePriceID;
