 ...
 */
package se.kth.servicerecommander.ejb.restservice;
...
import se.kth.servicerecommander.model.KaramelStatistics;
...
public class KaramelStatisticsFacadeREST extends AbstractFacade<KaramelStatistics> {
  ...
  public void create(KaramelStatistics entity) {
    super.create(entity);
  }
  ...
  @Override
  @Produces({"application/xml", "application/json"})
  public List<KaramelStatistics> findAll() {
