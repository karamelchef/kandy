 ...
 */
package se.kth.servicerecommander.cloud.common;
...
import se.kth.servicerecommander.cloud.common.exception.SshKeysNotfoundException;
...
public class SshKeyService {
  ...
  public static SshKeyPair loadSshKeys(String pubkeyPath, String prikeyPath, String passphrase) {
    ...
    try {
      ...
      if (pubKey == null || priKey == null) {
        logger.warn("Unsuccessful to load ssh keys. Will be generated");
      } else {
        logger.warn(String.format("Unsuccessful to load ssh keys from '%s' and/or '%s'. Will be generated",
